...
public class ItemEarthBow extends ItemBase
{
    public ItemEarthBow()
    {
        super("earth_bow");
            ...
            if (!itemstack.isEmpty() || flag)
            {
                ...
                if ((double)f >= 0.1D)
                {
                    ...
                    if (!worldIn.isRemote)
                    {
                        ...
                        entityarrow.shoot(entityplayer, entityplayer.rotationPitch, entityplayer.rotationYaw, 0.0F, f * 5.0F, 0.1F);
                        ...
                        if (j > 0)
                        {
                            entityarrow.setDamage(entityarrow.getDamage() + (double)j * 2.5D + 0.5D);
                        }
                        ...
                        if (k > 0)
                        {
                            entityarrow.setKnockbackStrength(2 + k);
                        }
